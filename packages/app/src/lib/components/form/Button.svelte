...
<style lang="scss">
	.button {
		...
		font: bold 14rem/36rem var(--font);
		text-transform: none;
		text-align: center;
		letter-spacing: 1rem;
		white-space: nowrap;
		...
		&.yellow {
			...
			color: var(--yellow-1);
			&:hover { color: var(--yellow-1) !important; }
		}
		&.green {
			background-color: var(--green-3);
			color: var(--green-1);
			&:hover { color: var(--green-2) !important; }
		}
		&.blue {
			background-color: var(--blue-3);
			&:hover { color: var(--blue-3) !important; }
		}
		&.purple {
			background-color: var(--purple-3);
			&:hover { color: var(--purple-3) !important; }
		}
		&.blank {
